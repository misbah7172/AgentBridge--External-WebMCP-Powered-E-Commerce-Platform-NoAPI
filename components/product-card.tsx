...
type ProductCardProps = { product: { id: string; slug: string; name: string; brand: string; category: { name: string }; price: unknown; rating: unknown; images: unknown } };
